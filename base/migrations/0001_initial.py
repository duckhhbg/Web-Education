# Generated by Django 3.2.7 on 2022-12-14 16:29
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('access', models.IntegerField(choices=[(0, 'Student'), (1, 'Teacher'), (2, 'Admin')], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('fkmajor', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='base.major')),
